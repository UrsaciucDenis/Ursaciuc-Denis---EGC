...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private bool piramida;
        private bool obiect1;
        private bool obiect2;

        private bool piramidaz1;
        private bool obiect1z1;
        private bool obiect2z1;

        private bool piramidaz2;
        private bool obiect1z2;
        private bool obiect2z2;
        ...
        private List<Vector3> fata = new List<Vector3>(); // piramida fete
        private List<Vector3> baza = new List<Vector3>(); // piramida baza

        private List<Vector3> fata1 = new List<Vector3>(); // obiect 1

        private List<Vector3> fata2 = new List<Vector3>(); // obiect 2
        ...
        private string filePiramida = "Piramida.txt";
        private string fileObiect1 = "ObiectNeregulat1.txt";
        private string fileObiect2 = "ObiectNeregulat2.txt";
        ...
        private void loadPiramida()
        {
            StreamReader f = new StreamReader(filePiramida);
            string ln;
            ...
            while ((ln = f.ReadLine()) != null)
            {
                if (ln.Split(' ')[0] == "f")
                {
                    fata.Add(new Vector3(Int32.Parse(ln.Split(' ')[1]), Int32.Parse(ln.Split(' ')[2]), Int32.Parse(ln.Split(' ')[3])));
                }

                if (ln.Split(' ')[0] == "b")
                {
                    baza.Add(new Vector3(Int32.Parse(ln.Split(' ')[1]), Int32.Parse(ln.Split(' ')[2]), Int32.Parse(ln.Split(' ')[3])));
                }
            }
        ...
        private void loadObiect1()
        {
            StreamReader f = new StreamReader(fileObiect1);
            string ln;
            ...
            while ((ln = f.ReadLine()) != null)
            {
                if (ln.Split(' ')[0] == "f")
                {
                    fata1.Add(new Vector3(Int32.Parse(ln.Split(' ')[1]), Int32.Parse(ln.Split(' ')[2]), Int32.Parse(ln.Split(' ')[3])));
                }
            }
        ...
        private void loadObiect2()
        {
            StreamReader f = new StreamReader(fileObiect2);
            string ln;
            ...
            while ((ln = f.ReadLine()) != null)
            {
                if (ln.Split(' ')[0] == "f")
                {
                    fata2.Add(new Vector3(Int32.Parse(ln.Split(' ')[1]), Int32.Parse(ln.Split(' ')[2]), Int32.Parse(ln.Split(' ')[3])));
                }
            }
        ...
        private void DeseneazaObiect1()
        {
            GL.PolygonMode(MaterialFace.FrontAndBack, PolygonMode.Fill);

            GL.Begin(PrimitiveType.Polygon);

            for (int i = 0; i < fata1.Count; i++)
            {
                switch (i % 5)
                {
                    case 0:
        ...
        private void DeseneazaObiect2()
        {
            GL.PolygonMode(MaterialFace.FrontAndBack, PolygonMode.Fill);

            GL.Begin(PrimitiveType.Polygon);

            for (int i = 0; i < fata2.Count; i++)
            {
                switch (i % 4)
                {
                    case 0:
        ...
        private void DeseneazaPiramida_Tex1()
        {
            if (brick == true)
            {
            ...
            for (int i = 0; i < fata.Count; i = i + 6)
            {
            ...
            for (int i = 0; i < baza.Count; i = i + 4)
            {
                GL.TexCoord2(0.0, 1.0);
                GL.Vertex3(baza[i]);
                GL.TexCoord2(1.0, 1.0);
        ...
        private void DeseneazaPiramida_Tex2()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
        ...
        private void DeseneazaObiect1_Tex1()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            for (int i = 0; i < fata1.Count; i = i + 4)
            {
                GL.TexCoord2(0.0, 1.0);
                GL.Vertex3(fata1[i]);
                GL.TexCoord2(1.0, 1.0);
                GL.Vertex3(fata1[i + 1]);
                GL.TexCoord2(1.0, 0.0);
                GL.Vertex3(fata1[i + 2]);
                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(fata1[i + 3]);
            }

            GL.End();
        }

        private void DeseneazaObiect1_Tex2()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
        ...
        private void DeseneazaObiect2_Tex1()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            for (int i = 0; i < fata2.Count; i = i + 4)
            {
                GL.TexCoord2(0.0, 1.0);
                GL.Vertex3(fata2[i]);
                GL.TexCoord2(1.0, 1.0);
                GL.Vertex3(fata2[i + 1]);
                GL.TexCoord2(1.0, 0.0);
                GL.Vertex3(fata2[i + 2]);
                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(fata2[i + 3]);
            }

            GL.End();
        }

        private void DeseneazaObiect2_Tex2()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
